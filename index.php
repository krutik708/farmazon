...
<html lang="en">
	...
	?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Farmazon &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Farmazon</b></span>
				Farmazon is e-commerce trading platform for grains & grocerries for the farmers...
			</p>
							...
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
									<p>
			                            ...
			                            <input type="radio" id="farmers" name="category" value="1" >
			                            <label for="farmers">Farmer</label>
			                        
			                            <input type="radio" id="buyers" name="category" value="0">
