...
-- --------------------------------------------------------
/*INSERT INTO 'buyer' (bname, busername, bpassword, bhash, bmobile, bemail, baddress)
    			VALUES ('vatsal','vatsal123','$2y$10$22ezmzHRa9c5ycHmVm5RpOnlT4LwFaDZar1XhmLRJQKGrcVRhPgti','61b4a64be663682e8cb037d9719ad8cd','9812145785','12@gmail.com','malad');
--*/
...
--
ALTER TABLE `buyer`
  MODIFY `bid` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;
--
